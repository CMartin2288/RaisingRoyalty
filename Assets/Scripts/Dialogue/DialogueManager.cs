...
public class DialogueManager : MonoBehaviour{
    ...
    void EventDialogue(Manager mgr, Dialogue dialogue){
        //checks if ending
        if (Manager.thisYear > 1) {
            ...
            //Destitute
            if (Manager.gold < 0 && Manager.canLose) {
        ...
        //execute other dialoge events with requirements
        else  if ( Manager.sick || Manager.gold < 30 || Manager.constitution > 80){
            // sick
            if (Manager.sick) {
